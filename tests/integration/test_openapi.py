...
class TestOpenAPISchema:
    ...
    def test_openapi_title_and_description(self) -> None:
    ...
    def test_v1_register_endpoint_in_schema(self) -> None:
    ...
    def test_v1_activate_endpoint_in_schema(self) -> None:
    ...
    def test_register_response_schema(self) -> None:
    ...
    def test_activate_request_schema(self) -> None:
    ...
    def test_activate_response_schema(self) -> None:
    ...
    def test_v1_tag_in_schema(self) -> None:
    ...
    def test_endpoints_tagged_with_v1(self) -> None:
